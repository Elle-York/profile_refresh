# Indicator 91893/4/5 LA ------------------------------------------------------

# Percentage of deaths of people (aged 65+) with a recorded 
# mention of dementia occurring in a care homes/homes/hospitals
...
df <- read_xlsx("SQLoutput/91893.91894.91895_CCG.xlsx",
...
df <- df %>%
  transmute(IndicatorID = 91895, # Your Indicator no. here
...
write.xlsx(df,file = "91895_CCG.xlsx", sheetName = "PHOLIO") # Change each time
