...
# Percentage of deaths of people (aged 65+) with a 
# recorded mention of dementia occurring at home
...
df <- fread("SQLoutput/91895_CCG.csv") # change for each indicator
...
write.xlsx(df,file = "91895_CCG.xlsx", sheetName = "PHOLIO")
