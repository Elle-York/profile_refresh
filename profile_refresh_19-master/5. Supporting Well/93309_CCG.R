...
# Age standardised rate of people (aged 65+) with a mention of unspecified dementia 
# using inpatient hospital services per 100,000 population
...
df <- fread("SQLoutput/93309_CCG.csv") # change for each indicator
...
write.xlsx(df,file = "93309_CCG.xlsx", sheetName = "PHOLIO")
