...
# Age standardised rate of people (aged 65+) with a mention of Alzheimer's 
# disease using inpatient hospital services per 100,000 population
...
df <- fread("SQLoutput/93307_CCG.csv") # change for each indicator
...
df <- df %>%
  transmute(IndicatorID = 93307, # Your Indicator no. here
...
write.xlsx(df,file = "93307_CCG.xlsx", sheetName = "PHOLIO")
